(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/app_c71574._.js", {
...
_s(Home, "Ghg2MgzjBER7OqUQv0sVz5Ctb4g=");
_c = Home;
const columns = [
    {
        field: "id",
...
const getJobs = async ()=>{
    ...
    const jobs = array.map(async (item, idx)=>{
        ...
        if (companyMatch !== null) {
            try {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get((0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$jobs$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jobDetailsApi"])(companyMatch[2].trim()));
...
//# sourceMappingURL=app_c71574._.js.map